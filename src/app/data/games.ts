export const games = [
  ...
  },
  {
    ...
    CheckMate is a variation designed to make chess community-driven, fun, and rewarding –– made possible with Blinks!
    ...
    4️⃣ All pooled funds are distributed to the winning side after the game ends.`,
